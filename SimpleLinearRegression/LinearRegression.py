...
class LinearRegression:
    ...
    def fit_gd(self, X_train, y_train, eta=0.01, n_iters=1e4, precision=1e-8):
        ...
        def gradient_descent(X_b, y, initial_theta, eta=0.01, n_iters=1e4, precision=1e-8):
            theta = initial_theta
            i_iters = 0
        ...
        self.theta_ = gradient_descent(X_b, y_train, initial_theta, eta)
        self.intercept_ = self.theta_[0]
        self.coefficents_ = self.theta_[1:]
        return self
